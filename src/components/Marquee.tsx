...
export default function Marquee() {
  return (
    <div className="font-display leading-[0.92]">
      <h1 className="text-[56px] font-bold tracking-tight text-paper">
        The TechForge
      </h1>
      <div className="mt-1 flex flex-wrap items-center gap-3 sm:gap-4 text-[56px] font-bold tracking-tight text-paper">
